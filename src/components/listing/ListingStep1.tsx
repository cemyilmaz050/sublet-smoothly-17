    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-3 sm:gap-4">
        <div>
          ...
          <Input id="bedrooms" type="number" inputMode="numeric" pattern="[0-9]*" min={0} placeholder="2" className="mt-1.5 text-base"
        ...
        <div>
          ...
          <Input id="bathrooms" type="number" inputMode="numeric" pattern="[0-9]*" min={0} placeholder="1" className="mt-1.5 text-base"
        ...
        <div>
          ...
          <Input id="sqft" type="number" inputMode="numeric" pattern="[0-9]*" min={0} placeholder="750" className="mt-1.5 text-base"
