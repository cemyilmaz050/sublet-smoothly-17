...
import {
  ...
  MessageSquare, Loader2, CalendarIcon, Lock, Home, KeyRound,
      ...
      {!user && (
        <section className="relative flex min-h-[calc(100dvh-4rem)] flex-col items-center justify-center bg-background px-4">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            >
              {[
                ...
                { icon: Building2, label: "Boston Brokerage Group approved" },
            ...
            >
              {[
                { value: stats.listings || allListings.length, label: "Active listings" },
          ...
          >
            ...
            >
              <ChevronDown className="h-5 w-5 text-muted-foreground" strokeWidth={1.5} />
            </motion.div>
          </motion.div>
        </section>
      )}
